...
RUN uv pip install  --no-cache-dir "git+https://github.com/apt-team-018/transformers-usf.git@${REF}#egg=transformers[testing, vision]" 'scikit-learn' 'torch-stft' 'nose'  'dataset'
