...
RUN uv pip install --no-cache-dir "scipy<1.13" "git+https://github.com/apt-team-018/transformers-usf.git@${REF}#egg=transformers[flax,audio,sklearn,sentencepiece,vision,testing]"
