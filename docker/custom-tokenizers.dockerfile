...
RUN uv pip install  --no-cache-dir "git+https://github.com/apt-team-018/transformers-omega3.git@${REF}#egg=transformers[ja,testing,sentencepiece,jieba,spacy,ftfy,rjieba]" unidic unidic-lite
